<script lang="ts">
  import {
    ...
    specialRules as specialRulesData,
    units,
  ...
  const weaponSpecialRules = $derived(
    [
      ...new Set(
        [...rangedWeapons, ...meleeWeapons].flatMap((w) => w.specialRules),
      ),
    ].sort(),
  );
  ...
  const specialRules = $derived(
    [
      ...new Set([
        ...uniqueProfiles.flatMap((p) => p.specialRules),
        ...weaponSpecialRules,
      ]),
    ].sort(),
  );
  ...
  function lookupRule(ruleName: string): SpecialRule | undefined {
    ...
    return (
      ...
      specialRulesData.find((r) =>
        ruleName.startsWith(r.name.replace(/ \(X\)$/, '')),
      )
    );
  }
        ...
        <div class="turn-sequence-sticky">
          <details class="ts-group">
            <summary class="section-title"
              >Turn Sequence <span class="page-ref">p.240</span></summary
            >

            <!-- 1. START -->
            <details class="phase-block">
              <summary class="phase-title"
                >1. Start Phase <span class="page-ref">p.240</span></summary
              >
              <ul class="phase-list">
                <li>
                  Administer <em>Effects</em> that begin or end at the start of the
                  turn.
                </li>
                <li>
                  If instructed by the effect's rule, the active player performs
                  a check.
                </li>
              </ul>
            </details>
            ...
            <details class="phase-block">
              <summary class="phase-title"
                >2. Movement Phase <span class="page-ref">p.242</span></summary
              >
              <details class="sub-section">
                ...
                <ul class="phase-list">
                  ...
                  <li>
                    <strong>Entering from Reserves:</strong> Move onto the battlefield
                    from your deployment zone edge. May shoot & charge.
                  </li>
                  <li>
                    <strong>Deep Strike</strong> (from turn 2): Place a model anywhere,
                    others within 6" & coherency. May only shoot. May make a disembark
                    move. Enemy may declare Intercept reactions, but not a reposition.
                  </li>
                  <li>
                    <strong>Outflank:</strong> Enter from any edge not within opposing
                    deployment zone or 7" of enemy. Embarked models may not charge
                    if they performed an outflank.
                  </li>
                </ul>
              </details>
              <details class="sub-section">
                <summary class="sub-title"
                  >2.2 Moving Units <span class="page-ref">p.243</span></summary
                >
                <ul class="phase-list">
                  <li>Move each model up to its Movement characteristic.</li>
                  <li>
                    <strong>Rush:</strong> Add Initiative to movement. Cannot shoot
                    or charge.
                  </li>
                  <li>
                    Cannot move if: entered from reserves, pinned, routed, or in
                    combat.
                  </li>
                  <li>
                    Models can't end within 1" of enemies or impassable terrain.
                  </li>
                </ul>
              </details>
              <details class="sub-section">
                <summary class="sub-title">
                  2.3 Routed Units <span class="page-ref">p.246</span>
                </summary>
                <ul class="phase-list">
                  <li>
                    Routed units must Fall Back, roll a D6 and add initiative,
                    then move toward the player's own deployment zone edge. If
                    in contact with edge, make a LD check. If failed, the unit
                    is removed. Otherwise suppressed.
                  </li>
                </ul>
              </details>
            </details>
            ...
            <details class="phase-block">
              <summary class="phase-title"
                >3. Shooting Phase <span class="page-ref">p.247</span></summary
              >
              <details class="sub-section">
                <summary class="sub-title">3.1 Shooting</summary>
                <p class="phase-note">
                  Rushed, locked in combat, or embarked units may not shoot.
                </p>
              ...
              <details class="sub-section">
                <summary class="sub-title"
                  >3.2 Morale <span class="page-ref">p.251</span></summary
                >
                <p class="phase-note">
                  Check with 2D6 if any condition below applies:
                </p>
                <table class="cs-table">
                  <thead
                    ><tr><th>Condition</th><th>Check</th><th>Fail</th></tr
                    ></thead
                  >
                  <tbody>
                    <tr
                      ><td>Out of Coherency</td><td>Cool</td><td>Suppressed</td
                      ></tr
                    >
                    <tr
                      ><td>Hit by Suppressive (X)</td><td>Cool</td><td
                        >Suppressed</td
                      ></tr
                    >
                    <tr
                      ><td>Hit by Stun (X)</td><td>Cool</td><td>Stunned</td></tr
                    >
                    <tr
                      ><td>Wound from Pinning (X)</td><td>Cool</td><td
                        >Pinned</td
                      ></tr
                    >
                    <tr
                      ><td>Wound from Panic (X)</td><td>LD</td><td>Routed</td
                      ></tr
                    >
            ...
            <details class="phase-block">
              <summary class="phase-title"
                >4. Assault Phase <span class="page-ref">p.252</span></summary
              >
              <details class="sub-section">
                <summary class="sub-title">4.1 Charges</summary>
                <ul class="phase-list">
                  <li>
                    Cannot charge if: in combat, rushed, pinned, or routed.
                  </li>
                  <li>
                    Stunned, Suppressed, or disembarked units make <em
                      >Disordered Charges</em
                    >.
                  </li>
                ...
                <ol class="phase-steps">
                  ...
                  <li>
                    Make Volley Attacks (Assault weapons & Snap Shots only)
                  </li>
                  <li>Make Charge Move (roll 2D6, pick highest)</li>
                </ol>
                <ul class="phase-list">
                  <li>
                    If in base contact after Set-up, charge complete — skip 4–5.
                  </li>
                  <li>Volley attacks never inflict statuses.</li>
                  <li>Disordered Charges: no Set-up Move or Volley Attacks.</li>
                  <li>
                    Not in base contact after step 5 → Cool check; fail =
                    Stunned.
                  </li>
                </ul>
              </details>
              <details class="sub-section">
                ...
                <p class="phase-note">
                  Available to non-routed Command / Champion / Paragon
                  sub-types.
                </p>
                <ol class="phase-steps">
                  <li>Declare Challenge (active player first)</li>
                  <li>
                    Face-off — select a Gambit (1st round: active player first)
                  </li>
                  ...
                  <li>
                    Glory Points — winner gains extra Combat Resolution points
                  </li>
                </ol>
              </details>
              <details class="sub-section">
                ...
                <p class="phase-note">
                  Resolved in initiative order, highest to lowest.
                </p>
                <ol class="phase-steps">
                  <li>Determine Combat</li>
                  <li>Declare Weapons (both sides)</li>
                  <li>
                    Combat Initiative — for each Initiative Step:
              ...
              <details class="sub-section">
                ...
                <p class="phase-note">
                  Failed Panic check → unit is Routed & must Fall Back.
                </p>
              </details>
            </details>
            ...
            <details class="phase-block">
              <summary class="phase-title"
                >5. End Phase <span class="page-ref">p.274</span></summary
              >
              <details class="sub-section">
                <summary class="sub-title">5.1 Effects</summary>
                <p class="phase-note">
                  Any effects that start or end at "End of the turn" happen
                  here.
                </p>
              </details>
              <details class="sub-section">
                ...
                <p class="phase-note">
                  Perform checks (Cool/LD) or Repairs (6+) to remove ongoing
                  statuses.
                </p>
              </details>
              <details class="sub-section">
                ...
                <p class="phase-note">
                  Score Mission Objectives and gain Victory Points if
                  applicable.
                </p>
              </details>
            </details>
          ...
          <!-- ─── TABLES ─── -->
          <details class="ts-group">
            <summary class="section-title">Tables</summary>

            <!-- Ranged Hit Test Table -->
            <details class="phase-block">
              <summary class="phase-title"
                >Ranged Hit Test <span class="page-ref">p.194</span></summary
              >
              <div class="table-scroll">
                <table class="cs-table cs-table-sm">
                  <thead>
                    <tr
                      ><th>BS</th><th>≥10</th><th>9</th><th>8</th><th>7</th><th
                        >6</th
                      ><th>5</th><th>4</th><th>3</th><th>2</th><th>1</th></tr
                    >
                  </thead>
                  <tbody>
                    <tr
                      ><td>Hit</td><td>A*</td><td>C3+</td><td>C4+</td><td
                        >C5+</td
                      ><td>C6+</td><td>2+</td><td>3+</td><td>4+</td><td>5+</td
                      ><td>6+</td></tr
                    >
                    <tr
                      ><td>Snap</td><td>2+</td><td>3+</td><td>4+</td><td>4+</td
                      ><td>4+</td><td>5+</td><td>5+</td><td>6+</td><td>6+</td
                      ><td>F*</td></tr
                    >
                  </tbody>
                </table>
            ...
            <details class="phase-block">
              ...
              <p class="phase-note">
                Cross-reference Attacker's WS (row) with Defender's WS (column).
              </p>
              <div class="table-scroll">
                <table class="cs-table cs-table-sm">
                  <thead>
                  ...
                  <tbody>
                    <tr
                      ><td>1</td><td>4+</td><td>6+</td><td>6+</td><td>6+</td><td
                        >6+</td
                      ><td>6+</td><td>6+</td><td>6+</td><td>6+</td><td>6+</td
                      ></tr
                    >
                    <tr
                      ><td>2</td><td>2+</td><td>4+</td><td>5+</td><td>6+</td><td
                        >6+</td
                      ><td>6+</td><td>6+</td><td>6+</td><td>6+</td><td>6+</td
                      ></tr
                    >
                    <tr
                      ><td>3</td><td>2+</td><td>3+</td><td>4+</td><td>5+</td><td
                        >5+</td
                      ><td>6+</td><td>6+</td><td>6+</td><td>6+</td><td>6+</td
                      ></tr
                    >
                    <tr
                      ><td>4</td><td>2+</td><td>2+</td><td>3+</td><td>4+</td><td
                        >5+</td
                      ><td>5+</td><td>5+</td><td>6+</td><td>6+</td><td>6+</td
                      ></tr
                    >
                    <tr
                      ><td>5</td><td>2+</td><td>2+</td><td>3+</td><td>3+</td><td
                        >4+</td
                      ><td>5+</td><td>5+</td><td>5+</td><td>5+</td><td>6+</td
                      ></tr
                    >
                    <tr
                      ><td>6</td><td>2+</td><td>2+</td><td>2+</td><td>3+</td><td
                        >3+</td
                      ><td>4+</td><td>4+</td><td>5+</td><td>5+</td><td>5+</td
                      ></tr
                    >
                    <tr
                      ><td>7</td><td>2+</td><td>2+</td><td>2+</td><td>3+</td><td
                        >3+</td
                      ><td>3+</td><td>4+</td><td>5+</td><td>5+</td><td>5+</td
                      ></tr
                    >
                    <tr
                      ><td>8</td><td>2+</td><td>2+</td><td>2+</td><td>2+</td><td
                        >3+</td
                      ><td>3+</td><td>3+</td><td>4+</td><td>5+</td><td>5+</td
                      ></tr
                    >
                    <tr
                      ><td>9</td><td>2+</td><td>2+</td><td>2+</td><td>2+</td><td
                        >3+</td
                      ><td>3+</td><td>3+</td><td>3+</td><td>4+</td><td>5+</td
                      ></tr
                    >
                    <tr
                      ><td>10</td><td>2+</td><td>2+</td><td>2+</td><td>2+</td
                      ><td>2+</td><td>3+</td><td>3+</td><td>3+</td><td>3+</td
                      ><td>4+</td></tr
                    >
                  </tbody>
                </table>
            ...
            <!-- Wound Test Table -->
            <details class="phase-block">
              <summary class="phase-title">Wound Test</summary>
              <p class="phase-note">
                Cross-reference Hit Strength (row) with Target Toughness
                (column). — = no wound possible.
              </p>
              <div class="table-scroll">
                <table class="cs-table cs-table-sm">
                  <thead>
                  ...
                  <tbody>
                    <tr
                      ><td>1</td><td>4+</td><td>5+</td><td>6+</td><td>6+</td><td
                        >—</td
                      ><td>—</td><td>—</td><td>—</td><td>—</td><td>—</td></tr
                    >
                    <tr
                      ><td>2</td><td>3+</td><td>4+</td><td>5+</td><td>6+</td><td
                        >6+</td
                      ><td>—</td><td>—</td><td>—</td><td>—</td><td>—</td></tr
                    >
                    <tr
                      ><td>3</td><td>2+</td><td>3+</td><td>4+</td><td>5+</td><td
                        >6+</td
                      ><td>6+</td><td>—</td><td>—</td><td>—</td><td>—</td></tr
                    >
                    <tr
                      ><td>4</td><td>2+</td><td>2+</td><td>3+</td><td>4+</td><td
                        >5+</td
                      ><td>6+</td><td>6+</td><td>—</td><td>—</td><td>—</td></tr
                    >
                    <tr
                      ><td>5</td><td>2+</td><td>2+</td><td>2+</td><td>3+</td><td
                        >4+</td
                      ><td>5+</td><td>6+</td><td>6+</td><td>—</td><td>—</td></tr
                    >
                    <tr
                      ><td>6</td><td>2+</td><td>2+</td><td>2+</td><td>2+</td><td
                        >3+</td
                      ><td>4+</td><td>5+</td><td>6+</td><td>6+</td><td>—</td
                      ></tr
                    >
                    <tr
                      ><td>7</td><td>2+</td><td>2+</td><td>2+</td><td>2+</td><td
                        >2+</td
                      ><td>3+</td><td>4+</td><td>5+</td><td>6+</td><td>6+</td
                      ></tr
                    >
                    <tr
                      ><td>8</td><td>2+</td><td>2+</td><td>2+</td><td>2+</td><td
                    ...
                    <tr
                      ><td>10</td><td>2+</td><td>2+</td><td>2+</td><td>2+</td
                      ><td>2+</td><td>2+</td><td>2+</td><td>2+</td><td>3+</td
                      ><td>4+</td></tr
                    >
                  </tbody>
                </table>
          ...
          <details class="ts-group">
            ...
            <details class="phase-block">
              <summary class="phase-title"
                >Seize the Initiative <span class="page-ref">p.310</span
                ></summary
              >
              <p class="phase-note">
                Before the first turn, the reactive player may roll a D6. On a
                6+, they take the first player turn instead.
              </p>
            </details>
            ...
            <details class="phase-block">
              <summary class="phase-title"
                >Reactions <span class="page-ref">p.206</span></summary
              >
              <ul class="phase-list">
                <li>Base Allotment: 1 Reaction per game turn.</li>
                <li>
                  &gt;1500 pts: +1 Reaction Point. Master of the Legion: +1.
                </li>
                <li>
                  &gt;3500 pts: +2 Reaction Points (+1 for Master of the
                  Legion).
                </li>
                <li>
                  Cannot react if: Stunned, Routed, in Combat, or already
                  reacted.
                </li>
              </ul>
              <div class="reaction-list">
                <div class="reaction-item">
                  ...
                  <p class="reaction-trigger">
                    After an enemy unit ends its move within 12" of this unit.
                    Move up to this unit's Initiative in any direction.
                  </p>
                </div>
                <div class="reaction-item">
                  <span class="reaction-name">Movement: Death or Glory</span
                  ><span class="reaction-cost">Cost 1</span>
                  <p class="reaction-trigger">
                    Enemy vehicle moves through unit and stops in base contact.
                    Select one ranged or melee weapon, attack as normal. If the
                    vehicle is not removed, the reacting model is removed.
                  </p>
                </div>
                <div class="reaction-item">
                  ...
                  >
                  <p class="reaction-trigger">
                    Enemy unit deploys from reserves. Perform Snap Shot attacks
                    (vehicles: defensive weapons only).
                  </p>
                </div>
                <div class="reaction-item">
                  ...
                  >
                  <p class="reaction-trigger">
                    After an enemy unit makes a Shooting attack against this
                    unit.
                  </p>
                </div>
                <div class="reaction-item">
                  ...
                  >
                  <p class="reaction-trigger">
                    Enemy unit performs a Charge move against this unit. Make a
                    normal Shooting attack instead of a Volley attack.
                  </p>
                </div>
                <div class="reaction-item">
                  ...
                  >
                  <p class="reaction-trigger">
                    Cavalry unit gets charged. After step 4, move up to the
                    reacting unit's Initiative.
                  </p>
                </div>
                <div class="reaction-item">
                  <span class="reaction-name">Assault: Heroic Intervention</span
                  ><span class="reaction-cost">Cost 1</span>
                  <p class="reaction-trigger">
                    If the active player did not declare a challenge. The
                    reactive player declares a challenge. If refused,
                    "Disgraced".
                  </p>
                </div>
              </div>
            ...
            <details class="phase-block">
              <summary class="phase-title"
                >Tactical Statuses <span class="page-ref">p.201</span></summary
              >
              <p class="phase-note">
                All statuses impose: Disordered Charges, Combat Initiative 1,
                cannot hold objectives, no Stationary benefits.
              </p>
              <div class="status-grid">
                <div class="status-item">
                  <span class="status-name">Pinned</span><span
                    class="status-desc"
                    >Can't Move, Rush or Charge. Can't Pursue or Disengage.</span
                  >
                </div>
                <div class="status-item">
                  <span class="status-name">Suppressed</span><span
                    class="status-desc">Attacks as Snap Shots only.</span
                  >
                </div>
                <div class="status-item">
                  <span class="status-name">Stunned</span><span
                    class="status-desc">Can't declare Reactions.</span
                  >
                </div>
                <div class="status-item">
                  <span class="status-name">Routed</span><span
                    class="status-desc"
                    >Must fall back during Movement. All other status penalties
                    apply.</span
                  >
                </div>
              </div>
            ...
            <details class="phase-block">
              ...
              <div class="aftermath-grid">
                <div class="aftermath-item">
                  <span class="aftermath-name">Fall Back</span><span
                    class="aftermath-desc"
                    >Gains Routed status. Perform 2.3 Routed Units move.</span
                  >
                </div>
                <div class="aftermath-item">
                  <span class="aftermath-name">Disengage</span><span
                    class="aftermath-desc"
                    >Normal move away from combat (only if lost). Affected by
                    terrain.</span
                  >
                </div>
                <div class="aftermath-item">
                ...
                <div class="aftermath-item">
                  <span class="aftermath-name">Pursue</span><span
                    class="aftermath-desc"
                ...
                <div class="aftermath-item">
                  <span class="aftermath-name">Gun Down</span><span
                    class="aftermath-desc"
                    >Immediately make a Volley attack targeting the unit that is
                    Falling Back.</span
                  >
                </div>
                <div class="aftermath-item">
                  <span class="aftermath-name">Hold</span><span
                    class="aftermath-desc"
                    >Immediately perform a pile-in move. If in base contact,
                    remain in combat</span
                  >
                </div>
              </div>
            </details>
            ...
            <details class="phase-block">
              ...
              <div class="gambit-list">
                <div class="gambit-item">
                  <span class="gambit-name">Seize the Initiative</span> — Roll an
                  extra Focus D6, discard lowest.
                </div>
                <div class="gambit-item">
                  <span class="gambit-name">Flurry of Blows</span> — +D3 attacks.
                  Attacks only do 1 Damage.
                </div>
                <div class="gambit-item">
                  <span class="gambit-name">Test the Foe</span> — Gain Challenge
                ...
                <div class="gambit-item">
                  <span class="gambit-name">Taunt & Bait</span> — Reduce WS & A to
                  match opponent. +1 Combat Resolution if you win.
                </div>
                <div class="gambit-item">
                ...
                <div class="gambit-item">
                  <span class="gambit-name">Finishing Blow</span> — Extra Focus D6,
                  discard highest. +1 Str & D to all hits.
                </div>
              </div>
            </details>
            ...
            <details class="phase-block">
              ...
              <p class="phase-note">
                The challenger who inflicted the most wounds wins. Winner gains
                Combat Resolution points equal to wounds inflicted. If the enemy
                is slain, gain points equal to its full Wounds characteristic
                instead.
              </p>
            </details>
            ...
            <details class="phase-block">
              ...
              <ul class="phase-list">
                <li>
                  <strong>1:</strong> Suffer 13 (–WP) wounds. Invulnerable saves
                  only.
                </li>
            ...
            <details class="phase-block">
              ...
              <table class="cs-table">
                <tbody>
                  ...
                  <tr
                    ><td><strong>Medium</strong></td><td
                      >5+ Cover. 3" Line of Sight.</td
                    ></tr
                  >
                  <tr
                    ><td><strong>Heavy</strong></td><td
                      >4+ Cover. Blocks Line of Sight.</td
                    ></tr
                  >
                  <tr
                    ><td><strong>Difficult</strong></td><td
                      >Reduce Movement by –2".</td
                    ></tr
                  >
                  <tr
