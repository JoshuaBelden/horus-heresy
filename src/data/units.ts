...
export const units: UnitProfile[] = [
  ...
  },
  {
    ...
    wargear: [],
    specialRules: ['Auto-Repair (4+)', 'Assault Vehicle', 'Transport Sub-Type'],
    traits: ['Legiones Astartes'],
    options: [
      {
        title: 'Hull (Front) Weapon',
        description:
          'Twin heavy bolter, or may be exchanged for one of the following:',
        required: true,
        choices: [
          {
            description: 'Twin heavy bolter',
            points: 0,
            weaponName: 'Twin heavy bolter',
          },
          {
            description: 'Twin heavy flamer',
            points: 0,
            weaponName: 'Twin heavy flamer',
          },
          {
            description: 'Twin lascannon',
            points: 10,
            weaponName: 'Twin lascannon',
          },
        ],
      },
      {
        title: 'Legion Super-heavy Sponsons',
        description:
          'Two Sponson Mounted lascannon arrays, or may exchange both for one of the following:',
        required: true,
        choices: [
          {
            description: 'Two Sponson Mounted lascannon arrays',
            points: 0,
            weaponName: 'Lascannon array',
          },
          {
            description: 'Two Sponson Mounted laser destroyers',
            points: 0,
            weaponName: 'Laser destroyer',
          },
          {
            description: 'Two Sponson Mounted Gravis heavy bolter batteries',
            points: 0,
            weaponName: 'Gravis heavy bolter battery',
          },
        ],
      },
      {
        title: 'Legion Pintle Weapons',
        description: 'May take one item from the Legion Pintle Weapons list.',
        weaponListNames: ['Legion Pintle Weapons'],
      },
      {
        title: 'Hunter-killer missile',
        description: 'May take a Hull (Front) Mounted Hunter-killer missile.',
        choices: [
          {
            description: 'Hull (Front) Mounted Hunter-killer missile',
            points: 5,
      ...
      {
        title: 'Searchlight',
        description: 'May take a Searchlight.',
        choices: [{ description: 'Searchlight', points: 5 }],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    description: '',
    composition:
      '1 Cataphractii Terminator Sergeant, 4 Cataphractii Terminators. May include up to 7 additional Cataphractii Terminators at +30 Points per Model.',
    models: [
      {
        name: 'Cataphractii Terminator Sergeant',
        count: 1,
        type: 'Infantry',
        subtypes: ['Sergeant', 'Heavy'],
        M: 6,
        WS: 4,
        BS: 4,
        S: 4,
    ...
    wargear: ['Volkite charger', 'Power sword'],
    specialRules: [
      'Bulky (2)',
      'Implacable Advance',
      'Vanguard (3)',
    ...
    options: [
      {
        description: 'May include up to 7 additional Cataphractii Terminators.',
        appliesTo: 'model-count',
        modelName: 'Cataphractii Terminator',
        pointsPerModel: 30,
        max: 7,
      },
      {
        description:
          'Any Cataphractii Terminator may exchange its volkite charger for a combi-bolter (free) or one item from the Legion Combi-weapons list.',
        appliesTo: 'per-model',
        modelName: 'Cataphractii Terminator',
        choices: [
          { description: 'Combi-bolter',        pointsPerModel: 0,  weaponName: 'Combi-bolter' },
          { description: 'Combi-flamer',        pointsPerModel: 10, weaponName: 'Combi-flamer' },
          { description: 'Combi-melta',         pointsPerModel: 10, weaponName: 'Combi-melta' },
          { description: 'Combi-plasma',        pointsPerModel: 10, weaponName: 'Combi-plasma' },
          { description: 'Combi-volkite',       pointsPerModel: 10, weaponName: 'Combi-volkite' },
          { description: 'Combi-grenade',       pointsPerModel: 10, weaponName: 'Combi-grenade' },
          { description: 'Combi-disintegrator', pointsPerModel: 10, weaponName: 'Combi-disintegrator' },
          { description: 'Combi-grav',          pointsPerModel: 10, weaponName: 'Combi-grav' },
        ],
      },
      {
        description:
          'Any Cataphractii Terminator may exchange its power weapon for one item from the Legion Terminator Melee Weapons list.',
        appliesTo: 'per-model',
        modelName: 'Cataphractii Terminator',
        choices: [
          { description: 'Power axe',           pointsPerModel: 0,  weaponName: 'Power axe' },
          { description: 'Power maul',          pointsPerModel: 0,  weaponName: 'Power maul' },
          { description: 'Power lance',         pointsPerModel: 0,  weaponName: 'Power lance' },
          { description: 'Calibanite Warblade', pointsPerModel: 5,  weaponName: 'Calibanite Warblade' },
          { description: 'Lightning claw',      pointsPerModel: 5,  weaponName: 'Lightning claw' },
          { description: 'Power fist',          pointsPerModel: 10, weaponName: 'Power fist' },
          { description: 'Chainfist',           pointsPerModel: 10, weaponName: 'Chainfist' },
          { description: 'Thunder hammer',      pointsPerModel: 10, weaponName: 'Thunder hammer' },
        ],
      },
      {
        description:
          'Any Cataphractii Terminator may exchange its volkite charger and power weapon for a pair of lightning claws.',
        appliesTo: 'per-model',
        modelName: 'Cataphractii Terminator',
        choices: [
          { description: 'Pair of lightning claws', pointsPerModel: 10, weaponName: 'Pair of lightning claws' },
        ],
      },
      {
        description:
          'The Cataphractii Terminator Sergeant may exchange its volkite charger for a combi-bolter (free) or one item from the Legion Combi-weapons list.',
        appliesTo: 'per-model',
        modelName: 'Cataphractii Terminator Sergeant',
        choices: [
          { description: 'Combi-bolter',        pointsPerModel: 0,  weaponName: 'Combi-bolter' },
          { description: 'Combi-flamer',        pointsPerModel: 10, weaponName: 'Combi-flamer' },
          { description: 'Combi-melta',         pointsPerModel: 10, weaponName: 'Combi-melta' },
      ...
      {
        description:
          'The Cataphractii Terminator Sergeant may exchange its power weapon for one item from the Legion Terminator Melee Weapons list.',
        appliesTo: 'per-model',
        modelName: 'Cataphractii Terminator Sergeant',
        choices: [
          { description: 'Power axe',           pointsPerModel: 0,  weaponName: 'Power axe' },
      ...
      {
        description:
          'The Cataphractii Terminator Sergeant may exchange its volkite charger and power weapon for a pair of lightning claws.',
        appliesTo: 'per-model',
        modelName: 'Cataphractii Terminator Sergeant',
        choices: [
          { description: 'Pair of lightning claws', pointsPerModel: 10, weaponName: 'Pair of lightning claws' },
