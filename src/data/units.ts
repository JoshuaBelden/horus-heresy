...
export const tacticalSquad: UnitProfile = {
  ...
  options: [
    {
      description: 'The Sergeant may replace their Bolter with one item from the Legion Sergeant Melee Weapons or Legion Combi-weapons lists.',
      appliesTo: 'unit',
      weaponListNames: ['Legion Sergeant Melee Weapons', 'Legion Combi-weapons'],
    },
    {
      description: 'The Sergeant may replace their Bolt Pistol with one item from the Legion Pistols or Legion Sergeant Melee Weapons lists.',
      appliesTo: 'unit',
    ...
    },
    {
      ...
      choices: [
        ...
        { description: 'Chain bayonet', points: 2, weaponName: 'Chain bayonet' },
      ],
    },
    {
    ...
    },
    {
      ...
      choices: [
        ...
        { description: 'Chain bayonet', pointsPerModel: 2, weaponName: 'Chain bayonet' },
      ],
    },
    {
      description: 'The unit may take a Vexilla.',
      appliesTo: 'unit',
      choices: [{ description: 'Vexilla', points: 10 }],
    },
    {
      description: 'The unit may take a Nuncio-vox.',
      appliesTo: 'unit',
      choices: [{ description: 'Nuncio-vox', points: 10 }],
    },
    {
      description: 'The unit may take an Augury scanner.',
      appliesTo: 'unit',
      choices: [{ description: 'Augury scanner', points: 10 }],
    },
  ],
};
